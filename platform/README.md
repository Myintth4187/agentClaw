...
| 变量 | 默认值 | 描述 |
|------|--------|------|
| `PLATFORM_DATABASE_URL` | `postgresql+asyncpg://frameclaw:frameclaw@localhost:5432/frameclaw_platform` | 数据库连接 |
...
# 启动服务（需要 PostgreSQL）
export PLATFORM_DATABASE_URL="postgresql+asyncpg://user:pass@localhost:5432/frameclaw_platform"
python -m app.main
```
